...
The **fast**/**unsafe** functions assume that the caller has done all the necessary sanity
checks for type, range, size and NAs, and does no checks for correctness.  These *unsafe*
functions offer up to ~50% speed increase over the **safe** image writing
functions.
